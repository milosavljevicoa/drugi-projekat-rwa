...
export const increaceNumberOfExercises = createAction(
  '[WorkoutRoutineEffect] Increase Number Of Exercises'
);

export const decreaseNumberOfExercises = createAction(
  '[WorkoutRoutineEffect] Decrease Number Of Exercises'
);
